...
# I will append this to the end of script.js inside a DOMContentLoaded block or just at the end.
tab_script = """
...
# Now inject a call to renderFactorySummary() at the end of calculateGlobal() or renderMainView().
# renderMainView calls calculateGlobal, so putting it at the end of renderMainView is perfect.
